    ...
    <Flex align="center" justify="center" bg="gray-50">
      ...
      >
        ...
        <Flex justify="center" mt={6}>
          <Button
            colorScheme="[#ff735c]"
            className="text-[#f5f5f5] hover:text-[#202020] bg-blue-500 hover:bg-blue-600 inline-flex items-center justify-center px-3 py-2 border border-transparent text-m font-medium rounded-md shadow-sm"
            onClick={handleBack}
          >
            <FaArrowLeft className="mr-2" />{" "}
            {/* Add the icon and some margin */}
            Back
          </Button>
        </Flex>
      </Box>
